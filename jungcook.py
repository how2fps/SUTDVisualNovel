...
#order is "text", "pic", "scene index", "name", "sound", 'affection check"
def JC(name):
       ...
       ("Didn’t expect gom-gom to have such a long queue today.", picmain, [37], "sounds/animalese (1).wav"),
       ...
       ("Huh didn’t expect to see you here again suspicious woman", picofJC, [39], "sounds/animalese (1).wav"),
       ("Nice to see you too!! Why can't you just say hello like normal people", picmain, [40], "sounds/animalese (1).wav"),
       ("And just to clarify I wasn’t being weird I just happen to be there when you arrive ", picmain, [41], "sounds/animalese (1).wav"),
       ("Whatever", picofJC, [42], "sound"),
       ("O what a sweet couple, we happen to have a promotion where you can get 2 sandwiches for 50%% off would you two like to share this?", picofshadow, [43], "sounds/animalese (1).wav"),
       ...
       ("Hmm I guess I will go to the pantry and get a snack.", picmain,name, [93], "sounds/animalese (1).wav"),
       ...
       #Day 5!!!!!!!!!!!!!!!!!!!
       ("Day 5", picofsun, [132]),
       ("(Today was a chill day, you enjoyed the peaceful moments (Affection with JungCook too low))", picmain, [156], {"NPC": JUNGCOOK, "comparison": BIGGER, "amount": 3, "altSceneIndex": 140 }),
       ("(You just finished her fifth row of volleyball training)", picmain, [133]),
       ("Good training guys, see you guys CHAOOO", picmain, [134], name, "sounds/animalese (1).wav"),
       ("Woo, all those workout got me famished, what do I want what do I want", picmain, [135], name, "sounds/animalese (1).wav"),
       ("Hmm Mcd sounds good, hmm meggi sounds amazing as well. O man how I wish I could just get both.", picmain, [136], name, "sounds/animalese (1).wav"),
       ("(As you are thinking about what to eat, JungCook approaches you)", picofJC, [137]),
       ("O hi, JC.", picmain, [138], name,"sounds/animalese (1).wav"),
       ("Yo, you free now? ", picofJC, [139], "JungCook", "sounds/animalese (1).wav"),
       ("YASss, why?", picmain, [140], name, "sounds/animalese (1).wav"),
       ("Nothing much just that remember when I owe you dinner, well I’m free now to cook for you", picofJC, [141], "JungCook", "sounds/animalese (1).wav"),
       ("", picofsun, [{"text": "LETSS GOOOOO", "nextSceneIndex": 142, "affection": {"affectedNPC": JUNGCOOK, "change": INCREASE}}, {"text": "Be Polite", "nextSceneIndex": 147, "affection": {"affectedNPC": JUNGCOOK, "change": NEUTRAL}}, {"text": "Reject Him", "nextSceneIndex": 151, "affection": {"affectedNPC": JUNGCOOK, "change": DECREASE}}]),
       ("Letss gooooooo, I was just nice hungry after training. I will say first, I not someone with a small stomach.", picmain, [143], name,"sounds/animalese (1).wav"),
       ("No problem, do you know who I am? My name is Cook, JungCook.", picofJC, [144], "JungCook", "sounds/animalese (1).wav"),
       ("Cooking a meal for the whole school wouldn’t be an issue to me much less one person.", picofJC, [145], "JungCook", "sounds/animalese (1).wav"),
       ("Hahha good, I shall feast tonight then.", picmain, [146], name,"sounds/animalese (1).wav"),
       ("(You followed JC to the block communal kitchen where JC had prepared the food ingredients beforehand. JC cooked a feast for you and you two enjoyed yourselves)", pic,[156]),
       ("Oo, I was just joking hahah, I wont force you to treat me dinner.", picmain, [148], name,"sounds/animalese (1).wav"),
       ("No issue, I have already prepared the ingredients in advanced. You can think of it as me treating my friend to dinner. I am your friend right?", picofJC, [149], "JungCook", "sounds/animalese (1).wav"),
       ("Of Course, well lets go then. Thank you for the meal.", picmain, [150], name,"sounds/animalese (1).wav"),
       ("(You followed JC to the block communal kitchen where JC had prepared the food ingredients beforehand. JC cooked a feast for you and you two enjoyed yourselves)", pic, [156]),
       ("Thanks but no thanks, imma go mac.", picmain, [152], name,"sounds/animalese (1).wav"),
       ("Actually picking mcd over my cooking? Tsk suit urself.", picofJC, [153], "JungCook", "sounds/animalese (1).wav"), 
       ("(JungCook walk away)", picofJC, [154]), 
       ("Eh whatever", picmain, [155], name,"sounds/animalese (1).wav"), 
       ("(You ordered mac delivery and enjoyed yourself)", picmain,[156]), 
       ("Day End", picofmoon, [157]), 
       #Day 6!!!!!!!!!!!!!!
       ("Day 6", picofsun, [158]), 
       ("", pic, [], 'sound'), 
       ("", pic, [], 'sound'), 
