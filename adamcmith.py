...
def AC(name):
    ...
    diag =  [("Day 1: Accidental Encounter at a Coffee Shop", "pictures/AdamCmith_Pic/001.png", [1]), 
            ...
            ("[You and Adam go to prom to gether]", "pictures/AdamCmith_Pic/Prom Night.png", [115]),
            ("[Congratulations You Win]", "pictures/AdamCmith_Pic/Prom Night.png", [115], '', '', None, True),
            #Bad ending index link 116
            ("Adam felt distence from you", "pictures/AdamCmith_Pic/No Prom.png", [117]),
            ("You Lose", "pictures/AdamCmith_Pic/No Prom.png", [117], '', '', None, True),
            ...
            ("What do you expect? You just friend zoned him...." , "pictures/AdamCmith_Pic/513.png", [123], "GM", "sounds/fzending.wav", '', None, True),#123
