...
def XIAO_MING(name):
       ...
       ["Okok, let’s do it.", "pictures/xiaoming/girl_talk_cinema.png", [176], name, girl_hey],
       ["Comedy sounds nice, however I am lowkey craving for something thrilling. Let’s watch The Nun instead.", sorry, [176], XM, "sounds/animalese (1).wav"],
       ...
       ["How about meeting again tomorrow? Same time. I swear that I won’t make you wait for me anymore!!", "pictures/xiaoming/xm_sad_cinema.png", [], XM, xm_hey],
