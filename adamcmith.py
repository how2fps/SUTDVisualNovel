...
def AC(name):
    ...
    diag =  [("Day 1: Accidental Encounter at a Coffee Shop", "pictures/AdamCmith_Pic/001.png", [1]), 
            ...
            #Good Option Choosen
            ("Hey Adam, you look like you could use a study buddy. Mind if I join you?", "pictures/AdamCmith_Pic/004.png", [4], name),
            (f"Oh, hey {name}! That would be amazing, come sit here!", "pictures/AdamCmith_Pic/005.png", [5], "Adam Cmith"),
            ("[The friend smiles warmly, appreciating her offer.]", "pictures/AdamCmith_Pic/005.png", [6]),
            ("What are you studying? Maybe two heads are better than one.", "pictures/AdamCmith_Pic/004.png", [7], name),
            ("It's for my HASS class. I'm really struggling with this chapter on The Theory of Moral Sentiments.", "pictures/AdamCmith_Pic/006.png", [8], "Adam Cmith"),
            ("Huh? Let's tackle it together. I'm pretty good with that stuff.", "pictures/AdamCmith_Pic/004.png", [9], name),
            ...
            ("(Waves at him) Hi Adamm, good luck with your studies!", "pictures/AdamCmith_Pic/007.png", [11], name),
            (f"Thanks, {name}! Enjoy your coffee.", "pictures/AdamCmith_Pic/005.png", [12], "Adam Cmith"),
            ("[He gives a brief smile and nods, focusing back on his work.]", "pictures/AdamCmith_Pic/001.png", [16]),
            #Bad Option Choosen
            ("Still the bookworm, I see. Ever thought of looking up from those books?", "pictures/AdamCmith_Pic/002.png", [14], name),
            ("Uh, yeah, I guess... Just a lot to cover.", "pictures/AdamCmith_Pic/006.png", [15], "Adam Cmith"),
            ...
            #Good Option Choosen
            ("Adam, what a pleasant surprise to see you here!", "pictures/AdamCmith_Pic/104.png", [21], name),
            (f"Hey, {name}! I didn't know you were in this study group. Great to have you with us!", "pictures/AdamCmith_Pic/105.png", [22], "Adam Cmith"),
            ...
            ("Hey Adam, is this seat next to you taken?", "pictures/AdamCmith_Pic/106.png", [24], name),
            ("No, it's free. Come sit here!", "pictures/AdamCmith_Pic/107.png", [25], "Adam Cmith"),
            ...
            #Neutral Option Choosen
            ("Hi everyone! Ready to crack these chapters?", "pictures/AdamCmith_Pic/109.png", [27], name),
            ("Definitely. Let's make the most of this session.", "pictures/AdamCmith_Pic/110.png", [28], "Adam Cmith and friends"),
            ...
            #Bad Option Choosen
            ("Adam? I didn't expect to see you here. Are you sure you're in the right group?", "pictures/AdamCmith_Pic/111.png", [30], name),
            ("Yeah, I've been part of this group for a while. Just focusing on my studies.", "pictures/AdamCmith_Pic/112.png", [31], "Adam Cmith"),
            ...
            #Good Option Choosen
            ("Hey, Adam, this is a beautiful spot. I had no idea you were into photography. Can I see what you've captured?", "pictures/AdamCmith_Pic/205.png", [37], name),
            (f"Oh, hi {name}! Sure, take a look. I just started last week so don’t expect much.", "pictures/AdamCmith_Pic/203.png", [38], "Adam Cmith"),
            ("No way! These are so beautiful!", "pictures/AdamCmith_Pic/204.png", [39], name),
            ("[They share a moment, appreciating the garden and his work.]", "pictures/AdamCmith_Pic/206.png", [40]),
            ("Hey, can you take a picture of me? Make sure I look good, ok?", "pictures/AdamCmith_Pic/205.png", [41], name),
            ("Of course, move here; these flowers really complement your outfit.", "pictures/AdamCmith_Pic/207.png", [42], "Adam Cmith"),
            ...
            #Bad Option Choosen
            ("Since when are you into photography? The camera does not fit you at all, haha.", "pictures/AdamCmith_Pic/210.png", [46], name),
            ("Ha ha ha… [Dry laugh] ", "pictures/AdamCmith_Pic/211.png", [47], "Adam Cmith"),
            ...
            ("You remember Buster, that little beagle we took care of last time? I heard he was adopted by a lovely family. It's bittersweet, isn't it? I'm happy to see him find a home, but I also miss him...", "pictures/AdamCmith_Pic/308.png", [57], name),
            ("Yeah, I'm glad he found a good home. It's these moments, isn't it? Seeing them happy and loved is what makes all of this so worthwhile.", "pictures/AdamCmith_Pic/309.png", [58], "Adam Cmith"),
            ...
            #Good Option Choosen
            ("Adam, your photographs are amazing! What inspires you to capture these moments?","pictures/AdamCmith_Pic/404.png", [69], name),
            ("Thanks! I find inspiration in everyday life, the small moments that tell a story. It means a lot that you appreciate it.", "pictures/AdamCmith_Pic/405.png", [70], "Adam Cmith"),
            ...
            ("Hey, this is the picture you took for me in the garden!?", "pictures/AdamCmith_Pic/406.png", [72], name),
            ("Yeah, that is one of my favorites and best works; it’s so captivating...", "pictures/AdamCmith_Pic/407.png", [73], "Adam Cmith"),
            ...
            #Neutral Option Choosen
            ("Nice work on these photos, Adam. You've got a good eye.", "pictures/AdamCmith_Pic/409.png", [75], name),
            ("Thanks, Feel free to look around the rest.", "pictures/AdamCmith_Pic/410.png", [76], "Adam Cmith"),
            ...
            #Bad Option Choosen
            ("These photos aren’t bad. Did you really take these yourself?", "pictures/AdamCmith_Pic/411.png", [78], name),
            ("Yeah, well, I have been practicing a lot and thought people would like it more...", "pictures/AdamCmith_Pic/412.png", [79], "Adam Cmith"),
            ...
            #Good Option Choosen
            ("Adam, I'm really glad we're here together. There's something special about this moment, don't you think?","pictures/AdamCmith_Pic/504.png", [84], name),
            ("I was thinking the same. It feels like everything's just right.", "pictures/AdamCmith_Pic/505.png", [85], "Adam Cmith"),
            ...
            ("You know, I've always found the ocean to be calming, but tonight, it feels even more special. Maybe it's the company.", "pictures/AdamCmith_Pic/507.png", [87], "Adam Cmith"),
            ("I've always loved the beach too. It's like all your worries just wash away with the tide.", "pictures/AdamCmith_Pic/508.png", [88], name),
            ...
            #Bad Option Choosen
            ("Nice weather for a beach walk, isn't it? It’s good to have a best friend to do these things with.", "pictures/AdamCmith_Pic/511.png", [92], name),
            ("Yeah, it's pretty great...", "pictures/AdamCmith_Pic/512.png", [93], "Adam Cmith"),
            ...
            ("Look what I got here, he says, pulling out his camera. I took some pictures during our beach walk yesterday." , "pictures/AdamCmith_Pic/012.png", [{"text": "Express love for the photos and appreciation for his thoughtfulness.", "nextSceneIndex": 99, "affection": {"affectedNPC": ADAMCMITH, "change": INCREASE}}, {"text": "Leave a quick comment on his photo and move on.", "nextSceneIndex": 108, "affection": {"affectedNPC": ADAMCMITH, "change": NEUTRAL}}, {"text": "Acknowledge the photos but express discomfort at being photographed so much.", "nextSceneIndex": 111, "affection": {"affectedNPC": ADAMCMITH, "change": DECREASE}}]),
            #Good Option Choosen
            ("These are beautiful, Adam! Although did you take photos of anything else, or was I your only subject?","pictures/AdamCmith_Pic/013.png", [100], name),
            ("Honestly, you were the most picturesque of all the surroundings. How could I focus on anything else?", "pictures/AdamCmith_Pic/014.png", [101], "Adam Cmith"),
            ("[You appreciated the comment and felt a warm feeling in your heart.]", "pictures/AdamCmith_Pic/015.png", [102]),
            ("Wow, I never thought you could say something like that; you have grown, don’t you?", "pictures/AdamCmith_Pic/016.png", [103], name),
            ("Well, I am tired of waiting, so how do you think of me?", "pictures/AdamCmith_Pic/017.png", [104], "Adam Cmith"),
            ("[The protagonist gives a slight pause, then, with a soft voice, she asks...] ", "pictures/AdamCmith_Pic/018.png", [105]),
            ("Will you go to prom with me?", "pictures/AdamCmith_Pic/019.png", [106], name),
            ("Of course I will.", "pictures/AdamCmith_Pic/020.png", [107], "Adam Cmith"),
            ...
            #Neutral Option Choosen
            ("You really do have talent here, Adam. These are very nice. Let's talk more later. I have a meeting at 5. Bye.", "pictures/AdamCmith_Pic/022.png", [109], name),
            ("Thank, he you later.", "pictures/AdamCmith_Pic/023.png", [110], "Adam Cmith"),
            ...
            #Bad Option Choosen
            ("These are nice, but... it's a little weird that you took so many pictures of me, don't you think?", "pictures/AdamCmith_Pic/024.png", [112], name),
            ...
            ("What do you expect? You just friend zoned him...." , "pictures/AdamCmith_Pic/513.png", [123], "GM"),#123
            ...
            ("Look what I got here, he says, pulling out his camera. I took some pictures during our beach walk yesterday." , "pictures/AdamCmith_Pic/012.png", [98], "Adam Cmith")#125
