...
def JC(name):
       ...
       ("WTF?!!??", picmain, [28], name, "sounds/animalese (1).wav"),
       ("Day End", picofmoon, [29]),
       ("Day 2 ", picofsun, [30]),
       ("(You just finished the last lesson of the day and is walking with your friend)", pic, [31]),
       ("Ahhh im stravinggg, wanna go eat gom-gom, canteen getting kinda boring", picmain, [32], name, "sounds/animalese (1).wav"),
       ("Sorry sis, i got project meeting right now. Have fun, CHAO!", "shadow human pic", [33], "Friend 1", "sounds/animalese (1).wav"),
       ("Everyday project, haiz guess im going gom-gom alone", picmain, [34], name , "sounds/animalese (1).wav"),
