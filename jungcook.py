...
def JC(name):
       diag = [
       ["Day 1", picofsun, [1]], 
       ["Haiz, why does uni have to be so hard. Why can't the proffessor just give everyone passes", picmain, [2], name, sound],
       ...
       ("Maybe I can sneak a peek at what dessert will be at prom in advanced!!", picmain, [7], name, sound), 
       ...
       ("Hellooo, did you not hear me. WHAT ARE YOU DOING HERE!!!", picofJC, [17], "JungCook", sound),
       ...
       ("BooBoo Gaga", pic, []),
       ("O nothing im just here chilling randomly outside a window, for no apparent reason, just ignore me. ", picmain, [20], name, sound),
       ("Okay weirdo, give me a reason why I shouldn’t just report you for suspicious activity huh.", picofJC, [21], "JungCook", sound),
       ("Because of that UFO over there", picmain, [22], name , sound),
       ("(As JungCook turns around, you immediately ran away.)", picmain, [23]),
       ("What the!?? What a interesting lady she is.", picofJC, [28], "JungCook", sound),
       ("(You stare at JungCook for awhile before turning and walking away)", picmain, [25]),
       ("????????", picofJC,[28], "JungCook"),
       ("O i'm just curious about what they are cooking ", picmain, [27], name, sound),
       ("If you are curious about cooking, how about you pay attention to our grub club telegram rather than stand outside like a weirdo", picofJC, [28], "JungCook", sound),
       ("WTF?!!??", picmain, [29], name, sound),
       ("Day End", picofmoon, [30]),
       #Day 2!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
       ("Day 2 ", picofsun, [31]),
       ("(You just finished the last lesson of the day and is walking with your friend)", pic, [32]),
       ("Ahhh im stravinggg, wanna go eat gom-gom, canteen getting kinda boring", picmain, [33], name, sound),
       ("Sorry sis, i got project meeting right now. Have fun, CHAO!", picofshadow, [34], "Friend 1", sound),
       ("Everyday project, haiz guess im going gom-gom alone", picmain, [35], name , sound),
       ("(Reaches Gom-Gom)", picofgomgom, [36]),
       ("Didn’t expect gom-gom to have such a long queue today.", picmain, [37], name, sound),
       ...
       ("Huh didn’t expect to see you here again suspicious woman", picofJC, [39], "JungCook", sound),
       ("Nice to see you too!! Why can't you just say hello like normal people", picmain, [40], name, sound),
       ("And just to clarify I wasn’t being weird I just happen to be there when you arrive ", picmain, [41], name,sound),
       ("Whatever", picofJC, [42], "JungCook", sound),
       ("O what a sweet couple, we happen to have a promotion where you can get 2 sandwiches for 50% off would you two like to share this?", picofshadow, [43], "CASHIER", sound),
       ...
       ("NOOO!!! I will take two chicken sandwichesss for myself, such a good offer", picmain, [45], name, sound),
       ("(JungCook rolling his eyes at your response)", picofJC, [46]),
       ("I will just have a avocado bowl thanks", picofJC, [47], "JungCook", sound),
       ...
       ("O no thanks, I will just have a chicken sandwich that’s all", picmain, [49],name, sound),
       ("Give me on avocado bowl thanks", picofJC, [50], "JungCook", sound),
       ("(As you are waiting for the food to be prepared)", "", [51]),
       ("You know you couldve ordered 2 chicken sandwich and split it with me, I wouldn’t have mind", picofJC, [52], "JungCook", sound),
       ("I didn’t want to them to get the wrong idea that we are dating, we just met recently afterall. ", picmain, [53], name, sound),
       ("We could be friends tho since we happened to meet coincidentally again so soon.", picmain, [54], sound),
       ("Sure im JungCook im sure you already know who I am", picofJC, [55], "JungCook", sound),
       ("Ahha I do know you, im {}, Nice to know you.".format(name), picmain, [56],name, sound),
       ("(After chatting while waiting for food, you left after taking your order. A new friendship was form)", pic, [61]),
       ("O no no no we aren't dating, he is just a random guy I met yesterday", picmain, [58], name, sound),
       ("As If my standards would be so low, I rather date a cow then her.", picofJC, [59], "JungCook", sound),
       ("Heyyyyy!!! Rude much", picmain, [60],name, sound),
       ...
       ("You shouldn’t eat snack so late at night you know, it's bad for your health.", picofshadow, [96], "UNKNOWN", sound),
       ...
       ("How bout Sukiya? Its nice and cheap?", picofshadow, [162], "Friend 1", sound), 
       ("I just had that yesterday though", picofshadow, [163], "Friend 2", sound), 
