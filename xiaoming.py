...
def XIAO_MING(name):
       ...
       ["", picmain, {"text": "A shoebag", "nextSceneIndex": , "affection": {"affectedNPC": XIAOMING, "change": INCREASE}}, {"text": "A bunch of snacks.", "nextSceneIndex": , "affection": {"affectedNPC": XIAOMING, "change": NEUTRAL}}, {"text": "A cute phone cover", "nextSceneIndex": , "affection": {"affectedNPC": XIAOMING, "change": DECREASE}}]],
       ...
       ["Wait.... how did you know I needed this, my old shoebag got holes in it and I was planning to replace it. This will do it for me!! Thanks so much!!", picmain, [], XM, "sounds/animalese (1).wav"],
       ["Oohhhh thanks!! This will push me through the late night studies!!", picmain, [], XM, "sounds/animalese (1).wav"],
       ["Ahh shit, my phone doesn’t fit into the cover 🙁 I appreciate it a lot though.", picmain, [], XM, "sounds/animalese (1).wav"],
       ["(You start walking around the shopping mall.)", picmain, [], "", "sounds/animalese (1).wav", {"NPC": XIAOMING, "comparison": BIGGER, "amount": 4, "altSceneIndex":}],
       ...
       ["", picmain, [], "", "sounds/animalese (1).wav"],
       ["", picmain, [], "", "sounds/animalese (1).wav"],
       ["", picmain, [], "", "sounds/animalese (1).wav"],
       ["", picmain, [], "", "sounds/animalese (1).wav"],
